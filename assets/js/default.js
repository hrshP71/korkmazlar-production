...
$(window).scroll(function () {
  ...
  if ($(window).width() < 768) {
    let nB = $('nav');
    let nM = $('.navbar').find("ul");
    let hB = $('.mobile-hamburger').next().children();
    nB.click(function () {
      nM.css("display", "flex");
      hB.animate({
        left: '0'
...
const typing = () => {
  if (i < heading.length) {
    document.querySelector('.i-love-asu').innerHTML += heading.charAt(i);
    i++;
...
$('.banner-image.animate').animate({
  marginLeft: 0
}, 1000);
$('.banner-image.animate-2').animate({
  marginLeft: 0
}, 1500);
$('.banner-image.animate-3').animate({
  marginLeft: 0
}, 2000);
$('.arr-container').animate({
  bottom: 10 + '%'
}, 2500)
...
let formfield = $('fieldset').click(function () {
  ...
  labelStyle.style.top = "-20px";

  $(this).focusout(function () {
    if (label[1].value.length > 0) {

    } else {
      labelStyle.style.color = "#222";
      labelStyle.style.top = "10px";
    }
...
labelHref = tabSet.find('label');

labelHref.click(function () {

  window.location.hash = '#hizmet-slider';
...
$(document).ready(function () {
  ...
  if ($(window).width() < 768) {
    ...
    const nB = $('nav');
    const nM = $('.navbar').find("ul");

    const hB = $('.mobile-hamburger').next().children();
    nB.click(function (e) {
      e.preventDefault();
      nM.css("display", "flex");
      hB.animate({
...
$(document).on('click', 'a[href^="#"]', function (event) {
  ...
  if ($(window).width() > 768) {
  ...
  } else if ($(this).hasClass('m-nav')) {
    let d = $('.mobile-hamburger');
    let n = d.next();

    n.css("transform", "rotate3d(1,1,1,120deg)");



    setTimeout(() => {
      n.css("transform", "rotateX(0)");
      n.hide();
      $('html, body').animate({
    ...
    $('html, body').animate({
      scrollTop: (($($.attr(this, 'href')).offset().top) - 300 + 'px')
    }, 500);
...
cake.click(function () {
  ...
  let dough = $(this).find('.dough');
  let icing = $(this).find('.icing');
  if (dough.css("height") == "0px") {
    dough.animate({
      height: 100 + '%'
    }, 700);
    icing.addClass('active');
  } else {
    dough.css("height", "0");
...
fontFace.click(function(){
  let b = $(this).find('.font-back');
  b.show("slow");
});
